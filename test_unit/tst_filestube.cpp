...
const QString request = "http://api.filestube.com/?key=ff5286516f86965dadfeb44bc87d4c36&sort=dd&extension=avi&phrase=";
...
void TestFilesTube::nominalCase ()
{
    ...
    QVERIFY2(this->_networkAccess->url() ==
             "http://api.filestube.com/?key=ff5286516f86965dadfeb44bc87d4c36&sort=dd&extension=avi&phrase=ubuntu",
             "Expected request");
